...
cargo clippy --release -- -W clippy::pedantic -W clippy::nursery -W clippy::correctness -W clippy::perf \
                          -W clippy::restriction -W clippy::style -W clippy::suspicious \
                          -W clippy::unwrap_used -W clippy::expect_used \
                          -A clippy::single_call_fn -A clippy::indexing_slicing -A clippy::missing_docs_in_private_items \
                          -A clippy::implicit_return -A clippy::unseparated_literal_suffix -A clippy::single_char_lifetime_names \
